...
public class WordDetect {
    public static String filePath = "D:/static/senseword/dictionary.txt";//敏感词库文件路径
    public static String directoryPath="D:/static/senseword";
    ...
    static{
        System.out.println("初始化敏感字过滤..");
        WordDetect.words = readTxtByLine(filePath);
        addBadWordToHashMap(WordDetect.words);
    }
    public static Set<String> readTxtByLine(String path){
        ...
        for(int i=0;i<files.length;i++) {
            ...
            File file=files[i];
            System.out.println("正在读取敏感词文件："+file.getAbsolutePath());
